...
class Miner:
    def __init__(self):
        ...
        if os.path.exists(os.path.join(path, 'Blockchain_System', 'Miner_3', 'blockchain.json')) == False:
        ...
        self.path = os.path.join(str(Path(__file__).parent).split('Miner_3')[0], 'Miner_3') # Change here for other Miners
