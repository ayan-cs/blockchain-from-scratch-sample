...
class Miner:
    def __init__(self):
        ...
        if os.path.exists(os.path.join(path, 'Blockchain_System', 'Miner_2', 'blockchain.json')) == False:
        ...
        self.path = os.path.join(str(Path(__file__).parent).split('Miner_2')[0], 'Miner_2') # Change here for other Miners
