...
class Miner:
    def __init__(self):
        ...
        if os.path.exists(os.path.join(path, 'Blockchain_System', 'Miner_7', 'blockchain.json')) == False:
        ...
        self.path = os.path.join(str(Path(__file__).parent).split('Miner_7')[0], 'Miner_7') # Change here for other Miners
