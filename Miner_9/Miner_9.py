...
class Miner:
    def __init__(self):
        ...
        if os.path.exists(os.path.join(path, 'Blockchain_System', 'Miner_9', 'blockchain.json')) == False:
        ...
        self.path = os.path.join(str(Path(__file__).parent).split('Miner_9')[0], 'Miner_9') # Change here for other Miners
