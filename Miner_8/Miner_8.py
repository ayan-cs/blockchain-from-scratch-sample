...
class Miner:
    def __init__(self):
        ...
        if os.path.exists(os.path.join(path, 'Blockchain_System', 'Miner_8', 'blockchain.json')) == False:
        ...
        self.path = os.path.join(str(Path(__file__).parent).split('Miner_8')[0], 'Miner_8') # Change here for other Miners
